...
# Models are configurable via env so the worker and evaluator can differ
# (e.g. a cheaper worker and a stronger evaluator).
WORKER_MODEL = os.getenv("WORKER_MODEL", "gpt-4o-mini")
EVALUATOR_MODEL = os.getenv("EVALUATOR_MODEL", "gpt-4o-mini")
# Safety cap on the worker/evaluator retry loop (the original had none).
...
class State(TypedDict):
    ...
    iterations: int  # how many times the evaluator has reviewed an answer
...
class AIAssistant:
    ...
    With this feedback, please continue the assignment, ensuring that you meet the success criteria or have a question for the user."""
        ...
        # Add in the system message (replace an existing one if present)
    ...
    def worker_router(self, state: State) -> str:
        ...
        return worker_route(has_tool_calls)
